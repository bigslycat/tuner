...
// export const Tuner: React$ComponentType<Props> = compose(
//   pure,
//   mapPropsStream(props$ =>
//     combineLatest(
//       props$.pipe(
//         map(props => {
//           const noteBlockSize = Value.parse(props.noteBlockSize || '2.6em');
//           return {
//             ...props,
//             noteBlockSize,
//             sliderSize: noteBlockSize.map(size => size * indexedNotes.length),
...
//         <Notes
//           current={props.noteLabel}
//           size={props.noteBlockSize}
//           notes={indexedNotes}
//         />
//       </Slider>
//     </SlideBox>
